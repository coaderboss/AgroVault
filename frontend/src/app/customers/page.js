      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-5 md:mb-8 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full md:w-auto">
          ...
          <button 
            ...
            className="w-full sm:w-auto justify-center bg-amber-500 hover:bg-amber-600 text-white px-4 md:px-6 py-2.5 md:py-3 rounded-xl md:rounded-2xl text-xs md:text-sm font-bold flex items-center gap-2 shadow-md shadow-amber-500/20 transition-all active:scale-95 whitespace-nowrap"
          >
              ...
              <div className="pt-2 md:pt-4 flex gap-3">
                ...
                >
                  {isSubmitting ? (
                    ...
                    <><Check size={18} className="md:w-5 md:h-5" /> Save Kisaan</>
                  )}
                </button>
              </div>
            </form>
